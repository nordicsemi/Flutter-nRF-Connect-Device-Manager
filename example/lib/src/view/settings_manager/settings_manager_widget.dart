      ...
      children: [
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  trailing: ElevatedButton(
                    onPressed: _connectingDeviceId != null ? null : () => _connectToDevice(device),
        ...
        if (_connectedDevice != null) ...[
          ...
          Row(
            ...
            children: [
              ElevatedButton(onPressed: _readAllSettings, child: const Text("Read All")),
              ElevatedButton(onPressed: _readSingleSetting, child: const Text("Read Single")),
              ElevatedButton(
