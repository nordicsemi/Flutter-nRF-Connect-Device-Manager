...
nonisolated struct ProtoUpdateCallArgument: Sendable {
  ...
  var configuration: ProtoFirmwareUpgradeConfiguration {
    get {_configuration ?? ProtoFirmwareUpgradeConfiguration()}
...
nonisolated struct ProtoError: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct ProtoImage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasSlot: Bool {self._slot != nil}
...
nonisolated struct ProtoUpdateWithImageCallArguments: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// STATE
nonisolated struct ProtoUpdateStateChangesStreamArg: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var updateStateChanges: ProtoUpdateStateChanges {
    get {_updateStateChanges ?? ProtoUpdateStateChanges()}
    set {_updateStateChanges = newValue}
  }
  /// Returns true if `updateStateChanges` has been explicitly set.
  var hasUpdateStateChanges: Bool {self._updateStateChanges != nil}
...
nonisolated struct ProtoUpdateStateChanges: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated enum FirmwareUpgradeState: SwiftProtobuf.Enum, Swift.CaseIterable {
...
nonisolated struct ProtoFirmwareUpgradeConfiguration: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated enum ImageUploadAlignment: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case disabled // = 0
    case twoByte // = 1
    case fourByte // = 2
  ...
  nonisolated enum FirmwareUpgradeMode: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case testOnly // = 0
    case confirmOnly // = 1
...
nonisolated struct ProtoProgressUpdateStreamArg: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var progressUpdate: ProtoProgressUpdate {
    get {_progressUpdate ?? ProtoProgressUpdate()}
    set {_progressUpdate = newValue}
  }
  /// Returns true if `progressUpdate` has been explicitly set.
  var hasProgressUpdate: Bool {self._progressUpdate != nil}
...
nonisolated struct ProtoProgressUpdate: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// LOGS
nonisolated struct ProtoLogMessageStreamArg: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var protoLogMessage: ProtoLogMessage {
    get {_protoLogMessage ?? ProtoLogMessage()}
    set {_protoLogMessage = newValue}
  }
  /// Returns true if `protoLogMessage` has been explicitly set.
  var hasProtoLogMessage: Bool {self._protoLogMessage != nil}
...
nonisolated struct ProtoLogMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  nonisolated enum LogCategory: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case transport // = 0
    case config // = 1
    case crash // = 2
...
nonisolated struct ProtoReadLogCallArguments: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct ProtoReadMessagesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// IMAGE MANAGER
nonisolated struct ProtoListImagesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct ProtoImageSlot: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension ProtoUpdateCallArgument: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoError: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoImage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoUpdateWithImageCallArguments: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoUpdateStateChangesStreamArg: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoUpdateStateChanges: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoUpdateStateChanges.FirmwareUpgradeState: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoFirmwareUpgradeConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoFirmwareUpgradeConfiguration.ImageUploadAlignment: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoFirmwareUpgradeConfiguration.FirmwareUpgradeMode: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoProgressUpdateStreamArg: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoProgressUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoLogMessageStreamArg: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoLogMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoLogMessage.LogCategory: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TRANSPORT\0\u{1}CONFIG\0\u{1}CRASH\0\u{1}DEFAULT\0\u{1}FS\0\u{1}IMAGE\0\u{1}LOG\0\u{1}RUN_TEST\0\u{1}STATS\0\u{1}DFU\0\u{1}SHELL\0\u{1}SUIT\0\u{1}MEMFAULT\0")
}

nonisolated extension ProtoLogMessage.LogLevel: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoReadLogCallArguments: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoReadMessagesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoListImagesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension ProtoImageSlot: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
